...
Asset.dml_attr = {
    'schema_name': 'GIS Asset index database',
    'dj_description': 'NO COMMENT SUPPLIED',
}

dml_dj_set_attr(
    Asset,
    "name",
    {'units': '', 'dj_css_class': 'CharField', 'dj_description': 'name'},
)
dml_dj_set_attr(
    Asset,
    "format",
    {
        'units': '',
        'dj_m2m_target': 'format',
        'dj_css_class': 'ManyToManyField',
        'dj_description': '',
    },
)
dml_dj_set_attr(
    ...
    {
        'units': '',
        'dj_css_class': 'DateTimeField',
        'dj_description': 'time of last modification',
    },
)
dml_dj_set_attr(
    Asset,
    ...
    {
        'units': '',
        'dj_css_class': 'IntegerField',
        'dj_description': 'records or bands',
    },
)
dml_dj_set_attr(
    Asset,
    "asset",
    {'units': '', 'dj_css_class': 'AutoField', 'dj_description': ''},
)
dml_dj_set_attr(
    Asset,
    "geom_type",
...
dml_dj_set_attr(
    ...
    {
        'units': '',
        'dj_css_class': 'AutoField',
        'dj_description': 'attribute type',
    },
)
dml_dj_set_attr(
    Attr_type,
...
class Bounds(models.Model):  # AUTOMATICALLY GENERATED
    ...
    srid = models.IntegerField(
        blank=True, null=True, help_text='Spatial Reference ID'
    )
    ...
    # maxy
    cellsx = models.IntegerField(
        blank=True, null=True, help_text='Raster cells in x axis'
    )
    # Raster cells in x axis
    cellsy = models.IntegerField(
        blank=True, null=True, help_text='Raster cells in y axis'
    )
    # Raster cells in y axis
    sizex = models.FloatField(
        blank=True, null=True, help_text='Raster cell x size'
    )
    # Raster cell x size
    sizey = models.FloatField(
        blank=True, null=True, help_text='Raster cell y size'
    )
    # Raster cell y size
...
dml_dj_set_attr(
    Bounds,
    "maxx",
    {'units': '', 'dj_css_class': 'FloatField', 'dj_description': 'maxx'},
)
dml_dj_set_attr(
    Bounds,
    "maxy",
    {'units': '', 'dj_css_class': 'FloatField', 'dj_description': 'maxy'},
)
dml_dj_set_attr(
    Bounds,
    "sizex",
    {
        'units': '',
        'dj_css_class': 'FloatField',
        'dj_description': 'Raster cell x size',
    },
)
dml_dj_set_attr(
    Bounds,
...
dml_dj_set_attr(
    ...
    "sizey",
    {
        'units': '',
        'dj_css_class': 'FloatField',
        'dj_description': 'Raster cell y size',
    },
)
dml_dj_set_attr(
    Bounds,
    "minx",
    {'units': '', 'dj_css_class': 'FloatField', 'dj_description': 'minx'},
)
dml_dj_set_attr(
    Bounds,
    "miny",
    {'units': '', 'dj_css_class': 'FloatField', 'dj_description': 'miny'},
)
dml_dj_set_attr(
    Bounds,
    "cellsy",
    {
        'units': '',
        'dj_css_class': 'IntegerField',
        'dj_description': 'Raster cells in y axis',
    },
)
dml_dj_set_attr(
    Bounds,
    "cellsx",
    {
        'units': '',
        'dj_css_class': 'IntegerField',
        'dj_description': 'Raster cells in x axis',
    },
)
dml_dj_set_attr(
    Bounds,
    "asset",
    {'units': '', 'dj_css_class': 'ForeignKey', 'dj_description': 'asset'},
)
dml_dj_set_attr(
    Bounds,
    "srid",
    {
        'units': '',
        'dj_css_class': 'IntegerField',
        'dj_description': 'Spatial Reference ID',
    },
)
...
dml_dj_set_attr(
    Path,
    "path_txt",
    {'units': '', 'dj_css_class': 'CharField', 'dj_description': 'path'},
)
dml_dj_set_attr(
    Path,
    "path",
    {'units': '', 'dj_css_class': 'AutoField', 'dj_description': 'path'},
)
dml_dj_set_attr(
    Path,
    "asset",
...
dml_dj_set_attr(
    ...
    "attribute",
    {
        'units': '',
        'dj_css_class': 'AutoField',
        'dj_description': 'attribute (column) of an asset',
    },
)
dml_dj_set_attr(
    Attribute,
...
dml_dj_set_attr(
    ...
    {
        'units': '',
        'dj_css_class': 'CharField',
        'dj_description': 'name of attribute',
    },
)
dml_dj_set_attr(
    Attribute,
    "attr_type",
    {'units': '', 'dj_css_class': 'ForeignKey', 'dj_description': ''},
)
...
Format.dml_attr = {
    'dj_m2m_target': 'format asset False',
    'schema_name': 'GIS Asset index database',
    'dj_description': 'NO COMMENT SUPPLIED',
}
...
dml_dj_set_attr(
    Format,
    "format",
    {'units': '', 'dj_css_class': 'AutoField', 'dj_description': 'format'},
)
...
Geom_type.dml_attr = {
    'dj_m2m_target': 'geom_type asset False',
    'schema_name': 'GIS Asset index database',
    'dj_description': 'NO COMMENT SUPPLIED',
}
...
class Drive(models.Model):  # AUTOMATICALLY GENERATED
    ...
    def __unicode__(self):
        return "%s: scanned %s //%s/%s" % (
            self.letter,
            self.last_scanned or 'never',
            self.machine,
            self.share,
        )
    ...
    last_scanned = models.DateField(
        blank=True, null=True, help_text='last scan date'
    )
    # last scan date
    user = models.CharField(
        max_length=4096, blank=True, help_text='password:user'
    )
    # password:user
    ip = models.CharField(
        max_length=4096, blank=True, help_text='IP to try if lookup fails'
    )
    # IP to try if lookup fails


Drive.dml_attr = {
    'dj_name': '"%s: scanned %s //%s/%s" % (self.letter, self.last_scanned or \'never\', self.machine, self.share)',
    'schema_name': 'GIS Asset index database',
    'dj_description': 'NO COMMENT SUPPLIED',
}
...
dml_dj_set_attr(
    ...
    {
        'units': '',
        'dj_css_class': 'DateField',
        'dj_description': 'last scan date',
    },
)
dml_dj_set_attr(
    Drive,
    "ip",
    {
        'units': '',
        'dj_css_class': 'CharField',
        'dj_description': 'IP to try if lookup fails',
    },
)
dml_dj_set_attr(
    Drive,
    "share",
    {'units': '', 'dj_css_class': 'CharField', 'dj_description': 'share name'},
)
dml_dj_set_attr(
    Drive,
    "drive",
    {'units': '', 'dj_css_class': 'AutoField', 'dj_description': 'drive'},
)
dml_dj_set_attr(
    Drive,
    "machine",
