...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Drive.ip'
        db.add_column('drive', 'ip', self.gf('django.db.models.fields.CharField')(default='', max_length=4096, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Drive.ip'
        db.delete_column('drive', 'ip')
