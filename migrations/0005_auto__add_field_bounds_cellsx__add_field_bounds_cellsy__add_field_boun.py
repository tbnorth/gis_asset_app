...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bounds.cellsx'
        db.add_column('bounds', 'cellsx',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bounds.cellsy'
        db.add_column('bounds', 'cellsy',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bounds.sizex'
        db.add_column('bounds', 'sizex',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bounds.sizey'
        db.add_column('bounds', 'sizey',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Bounds.srid'
        db.alter_column('bounds', 'srid', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Bounds.cellsx'
        db.delete_column('bounds', 'cellsx')

        # Deleting field 'Bounds.cellsy'
        db.delete_column('bounds', 'cellsy')

        # Deleting field 'Bounds.sizex'
        db.delete_column('bounds', 'sizex')

        # Deleting field 'Bounds.sizey'
        db.delete_column('bounds', 'sizey')


        # Changing field 'Bounds.srid'
        db.alter_column('bounds', 'srid', self.gf('django.db.models.fields.IntegerField')(default=-1))
    ...
    models = {
        ...
        'gis_asset.bounds': {
            ...
            'cellsx': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cellsy': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'sizex': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'sizey': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'gis_asset.drive': {
            ...
            'ip': ('django.db.models.fields.CharField', [], {'max_length': '4096', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.CharField', [], {'max_length': '4096', 'blank': 'True'})
        },
        'gis_asset.format': {
