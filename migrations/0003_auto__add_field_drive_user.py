...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Drive.user'
        db.add_column('drive', 'user', self.gf('django.db.models.fields.CharField')(default='', max_length=4096, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Drive.user'
        db.delete_column('drive', 'user')
